...
function Servhero() {
  return (
    <section className="h-[50vh] md:h-[75vh] sm:h-[40vh] rounded-sm bg-body py-5">
      <div
        className="h-full w-[88vw] m-auto rounded-sm md:rounded-xl overflow-hidden bg-cover bg-center flex items-center justify-center shadow-[0_0_10px_4px_rgba(0,0,0,0.2)] mb-5%"
        style={{
